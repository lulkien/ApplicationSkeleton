...
#include "../../AppSkeleton/hdr/AppEngine.h"
...
QT_MOC_LITERAL(1, 10, 16), // "slotReceiveEvent"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 5) // "event"

    },
    "AppEngine\0slotReceiveEvent\0\0event"
};
...
void AppEngine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->slotReceiveEvent((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
