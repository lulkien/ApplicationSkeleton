...
#include "../../AppSkeleton/hdr/AppModel.h"
...
QT_MOC_LITERAL(1, 9, 18), // "currentPathChanged"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 14), // "setCurrentPath"
QT_MOC_LITERAL(4, 44, 11) // "currentPath"

    },
    "AppModel\0currentPathChanged\0\0"
    "setCurrentPath\0currentPath"
};
...
void AppModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->setCurrentPath((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AppModel::currentPathChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void AppModel::currentPathChanged()
{
